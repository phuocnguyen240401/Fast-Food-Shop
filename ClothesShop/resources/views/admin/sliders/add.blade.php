            ...
            <div class="card-body card-block">
                <form action="" method="post" class="" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="url" placeholder="Nhập đường dẫn " class="form-control" value="{{ old('url') }}">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="sort_by" placeholder="Nhập ...." class="form-control" value="{{ old('sort_by') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" id="" class="btn btn-primary btn-sm">
                            <i class="fa fa-dot-circle-o"></i> Thêm Slider
                        </button>
