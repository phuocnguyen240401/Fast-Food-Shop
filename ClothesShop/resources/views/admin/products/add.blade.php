            ...
            <div class="card-body card-block">
                <form action="" method="post" class="" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="price" placeholder="Nhập giá sản phẩm" class="form-control" value="{{ old('price') }}">

                    </div>
                    <div class="form-group">
                        <label class=" form-control-label">Giá Khuyến mãi:</label>
                        <input type="number" name="price_sale" placeholder="Nhập giá sản phẩm" class="form-control" value="{{ old('price_sale') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" placeholder="Vui lòng nhập mô tả..." class="form-control">{{ old('description') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class=" form-control-label">Mô Tả Chi Tiết:</label>
                        <textarea name="content" id="content" placeholder="Vui lòng nhập mô tả chi tiết..." class="form-control">{{ old('content') }}</textarea>
                    </div>
